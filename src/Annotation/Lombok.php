...
class Lombok extends AbstractAnnotation implements GetterAnnotationInterface, SetterAnnotationInterface, LoggerAnnotationInterface, ToArrayAnnotationInterface, ToCollectionAnnotationInterface, OfAnnotationInterface
{
